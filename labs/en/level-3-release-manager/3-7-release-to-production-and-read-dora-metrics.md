---
id: lab-3-7
title: "Lab 3.7 - Release to production and read your DORA metrics"
...
This is the same mechanism as Lab 3.6, twice: `uat` into `preprod`, then `preprod` into `main`. With one
...
- [ ] Lab 3.6 finished: `uat` carries the release and the testers signed it off
...
yes. On this project that person is you, and you did it in Lab 3.6 step 5.
...
When the check finishes, read the sfdx-hardis comment the way Lab 3.3 taught, and add two questions
...
[Next: Lab 3.8 - Production is broken: hotfix and retrofit](3-8-hotfix-and-retrofit.md){ .md-button .md-button--primary }
